...
import minh095.braintraining.model.ModelColorAndTextQuestion;
...
public class ColorAndTextActivity extends BaseActivityNoToolbar implements Animator.AnimatorListener,
    ...
    private ColorAndTextQuestion currentQuestion;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_color_and_text);
        initRealm();
    ...
    public void showDialogResultGame(ColorAndTextQuestion currentQuestion) {
        ...
        realm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                Game trueFalseGame = realm.where(Game.class).contains("nameGame", "colorAndTextGame").findFirst();
    ...
    public void onAnimationStart(Animator animation) {
        if (!checkPauseGame) {
            currentQuestion = ModelColorAndTextQuestion.getCurrentColorTextAndQuestion();
            tvQuestion.setBackgroundColor(Color.parseColor(currentQuestion.getColorCode()));
            tvQuestion.setText(currentQuestion.getColorName());
            isCorrect = false;
        }
